...
- Name: auth/a-signup.spec.ts >> A3: existing unconfirmed user >> A3: unconfirmed re-signup shows confirmation screen; no silent password overwrite message
- Location: e2e/auth/a-signup.spec.ts:132:7
  ...
  - region "Create account":
    ...
    - tabpanel "Create your Feastpot account":
      ...
      - textbox "Email address":
        ...
        - text: existing+unconfirmed-1786970126089@example-feastpot.com
