...
- Name: auth/a-signup.spec.ts >> A4: enumeration timing safety >> A4: response body is identical for new vs confirmed user (no field reveals account existence)
- Location: e2e/auth/a-signup.spec.ts:211:7
  ...
  - region "Create account":
    ...
    - tabpanel "Create your Feastpot account":
      ...
      - textbox "Email address":
        ...
        - text: enum-body-1786970148220@example-feastpot.com
