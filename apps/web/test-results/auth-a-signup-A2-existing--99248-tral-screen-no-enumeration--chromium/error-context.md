...
- Name: auth/a-signup.spec.ts >> A2: existing confirmed user >> A2: existing confirmed email shows identical neutral screen (no enumeration)
- Location: e2e/auth/a-signup.spec.ts:106:7
  ...
  - region "Create account":
    ...
    - tabpanel "Create your Feastpot account":
      ...
      - textbox "Email address":
        ...
        - text: existing+confirmed-1786970115009@example-feastpot.com
