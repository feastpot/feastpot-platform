...
function buildAdminPlatformFactsModel(currentVendorTermsVersion: string): PlatformFactsModel {
  return {
...
export async function PlatformFacts() {
  const facts = buildAdminPlatformFactsModel(await getCurrentTermsVersion());
