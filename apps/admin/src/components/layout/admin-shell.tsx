...
const MAIN_NAV: ReadonlyArray<NavItem> = [
  ...
  { href: '/dead-letters', label: 'Dead-letter Bull jobs', icon: AlertTriangle, roles: ['admin'] },
  { href: '/analytics', label: 'Vendor acquisition', icon: BarChart3, roles: ['admin', 'finance', 'support'] },
  ...
  { href: '/compliance', label: 'Compliance', icon: ShieldCheck, roles: ['admin', 'compliance'] },
  {
    ...
    description: 'Terms, acceptance coverage, notices, appeals, evidence export',
  },
