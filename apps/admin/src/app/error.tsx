...
/**
 * Route-segment error boundary for the admin panel. Rendered inside the root
 * layout, so brand tokens are available. Admin leans on shadcn semantic tokens,
 * so the primary action uses `bg-primary`.
 */
      ...
      <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 text-center shadow-sm">
        ...
        <div className="mt-6 flex flex-col gap-2">
          <button
            type="button"
            onClick={reset}
            className="inline-flex w-full items-center justify-center rounded-xl bg-primary px-6 py-3 text-sm font-bold text-primary-foreground shadow-sm transition hover:bg-primary/90"
          >
            Try again
          </button>
          <button
