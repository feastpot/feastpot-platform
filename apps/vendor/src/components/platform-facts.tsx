...
function buildVendorPlatformFactsModel(currentVendorTermsVersion: string): PlatformFactsModel {
  return {
...
export async function PlatformFacts() {
  const facts = buildVendorPlatformFactsModel(await getCurrentTermsVersion());
