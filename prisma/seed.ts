...
async function main() {
  ...
  const mainMenu = await prisma.menu.upsert({
    where: {
      id:
        (await prisma.menu.findFirst({ where: { vendorId: maman.id, name: 'Main Menu' } }))?.id ??
  ...
  const frozenMenu = await prisma.menu.upsert({
    where: {
      id:
        (await prisma.menu.findFirst({ where: { vendorId: maman.id, name: 'Frozen Packs' } }))
  ...
  const items = await prisma.$transaction([
    prisma.menuItem.create({
      data: {
        ...
        description: 'Slow-cooked egusi with goat meat, smoked fish & spinach. Serves 6–8.',
    ...
    prisma.menuItem.create({
      data: {
        ...
        vendorId: maman.id,
        menuId: mainMenu.id,
        name: 'Jollof Rice (Full Tray)',
        description: 'Smoky party jollof with chicken stock base. Serves 10–12.',
        category: ItemCategory.tray,
        pricePence: 2800,
        servingsCount: 11,
        allergens: [],
        tags: ['halal'],
    ...
    prisma.menuItem.create({
      data: {
        ...
        vendorId: maman.id,
        menuId: mainMenu.id,
        name: 'Pounded Yam (6 portions)',
        description: 'Hand-pounded yam, vacuum-sealed.',
        category: ItemCategory.swallow,
        pricePence: 1800,
        servingsCount: 6,
        allergens: [],
        tags: ['halal'],
    ...
    prisma.menuItem.create({
      data: {
        ...
        vendorId: maman.id,
        menuId: mainMenu.id,
        name: 'Pepper Soup (Full Pot)',
        description: 'Catfish pepper soup with calabash nutmeg. Serves 8.',
        category: ItemCategory.soup,
        pricePence: 3500,
        servingsCount: 8,
        allergens: ['fish'],
    ...
    prisma.menuItem.create({
      data: {
        ...
        vendorId: maman.id,
        menuId: mainMenu.id,
        name: 'Suya Skewers (20 sticks)',
        description: 'Beef suya with ground peanut yaji.',
    ...
    prisma.menuItem.create({
      data: {
        ...
        vendorId: maman.id,
        menuId: mainMenu.id,
        name: 'Fried Plantain (Large)',
        description: 'Sweet ripe plantain, fried in vegetable oil.',
    ...
    prisma.menuItem.create({
      data: {
        ...
        vendorId: maman.id,
        menuId: mainMenu.id,
        name: 'Small Chops Party Pack (100pcs)',
        description: 'Puff-puff, samosa, spring roll, peppered chicken.',
    ...
    prisma.menuItem.create({
      data: {
        isAvailable: true,
        vendorId: maman.id,
        menuId: frozenMenu.id,
        name: 'Egusi Soup Frozen Pack (2 portions)',
        description: 'Reheat-from-frozen egusi, vacuum sealed.',
    ...
    prisma.menuItem.create({
      data: {
        ...
        vendorId: maman.id,
        menuId: mainMenu.id,
        name: 'Jerk Chicken (Full Tray)',
        description: 'Marinated 24h, grilled over pimento wood. Serves 10.',
        category: ItemCategory.tray,
        pricePence: 3800,
        servingsCount: 10,
        allergens: [],
    ...
    prisma.menuItem.create({
      data: {
        ...
        vendorId: maman.id,
        menuId: mainMenu.id,
        name: 'Rice and Peas (Full Tray)',
        description: 'Coconut rice with red kidney beans. Serves 10.',
        category: ItemCategory.tray,
        pricePence: 2400,
        servingsCount: 10,
        allergens: [],
    ...
    prisma.menuItem.create({
      data: {
        ...
        vendorId: maman.id,
        menuId: mainMenu.id,
        name: 'Oxtail Stew (Full Pot)',
        description: 'Slow-braised oxtail with butter beans. Serves 6–8.',
        category: ItemCategory.soup,
        pricePence: 4500,
        servingsCount: 7,
        allergens: [],
    ...
    prisma.menuItem.create({
      data: {
        ...
        vendorId: maman.id,
        menuId: mainMenu.id,
        name: 'Festival Bread (24 pieces)',
        description: 'Sweet fried dough - perfect with jerk chicken.',
        category: ItemCategory.snack,
        pricePence: 1600,
        servingsCount: 12,
        allergens: ['gluten'],
  ...
  const kwameMenu = await prisma.menu.upsert({
    where: {
      id:
        (await prisma.menu.findFirst({ where: { vendorId: kwame.id } }))?.id ??
  ...
  const kwameJollof = await prisma.menuItem.create({
    data: {
      ...
      vendorId: kwame.id,
      menuId: kwameMenu.id,
      name: 'Ghana Jollof (Full Tray)',
      description: 'Long-grain jollof with shito on the side. Serves 10.',
      category: ItemCategory.tray,
      pricePence: 3000,
      servingsCount: 10,
      allergens: [],
  ...
  await prisma.menuItem.create({
    data: {
      ...
      vendorId: kwame.id,
      menuId: kwameMenu.id,
      name: 'Waakye (Full Tray)',
      description: 'Rice-and-beans with shito, gari & boiled egg. Serves 10.',
      category: ItemCategory.tray,
      pricePence: 2800,
      servingsCount: 10,
      allergens: ['egg'],
  ...
  const EXTRA_VENDORS: ExtraVendorSpec[] = [
    {
      ...
      items: [
        {
          name: 'Chicken Tikka Biryani (Full Tray)',
          description: 'Basmati rice layered with marinated chicken tikka and saffron. Serves 10.',
          category: ItemCategory.tray,
          pricePence: 3400,
          servingsCount: 10,
          tags: ['halal'],
        ...
        {
          name: 'Dal Makhani (Family Pot)',
          description: 'Black urad dal slow-simmered overnight with cream and butter. Serves 6.',
          category: ItemCategory.soup,
          pricePence: 2200,
          servingsCount: 6,
          allergens: ['dairy'],
        ...
        {
          name: 'Tandoori Mixed Grill (20 skewers)',
          description: 'Chicken tikka, seekh kebab, lamb chops - straight from the clay oven.',
          category: ItemCategory.protein,
          pricePence: 4200,
          servingsCount: 8,
          tags: ['halal', 'spice:2'],
        ...
        {
          name: 'Garlic Naan (12 pieces)',
          description: 'Fresh tandoor-baked naan brushed with garlic butter.',
          category: ItemCategory.snack,
          pricePence: 1200,
          servingsCount: 6,
        ...
        {
          name: 'Punjabi Chole (Full Pot)',
          description: 'Chickpeas in a tomato-onion masala. Serves 6–8.',
          category: ItemCategory.soup,
          pricePence: 1800,
          servingsCount: 7,
          tags: ['vegan'],
        ...
        {
          name: 'Mango Lassi (2L jug)',
          description: 'Sweet alphonso mango with house-set yoghurt.',
          category: ItemCategory.snack,
          pricePence: 900,
          servingsCount: 8,
          allergens: ['dairy'],
    ...
    },
    {
      ...
      items: [
        {
          name: 'Sindhi Mutton Biryani (Full Tray)',
          description: 'Spice-forward Sindhi biryani with bone-in mutton. Serves 10.',
          category: ItemCategory.tray,
          pricePence: 4200,
          servingsCount: 10,
          tags: ['halal', 'spice:3'],
        ...
        {
          name: 'Beef Nihari (Full Pot)',
          description: 'Slow-cooked overnight nihari with bone marrow. Serves 6.',
          category: ItemCategory.soup,
          pricePence: 3600,
          servingsCount: 6,
          allergens: ['gluten'],
        ...
        {
          name: 'Chicken Haleem (Family Pot)',
          description: 'Lentils, wheat, and shredded chicken - the Karachi way.',
          category: ItemCategory.soup,
          pricePence: 2800,
          servingsCount: 8,
          allergens: ['gluten'],
        ...
        {
          name: 'Seekh Kebab (24 sticks)',
          description: 'Mince beef seekh on charcoal. Bring your own naan.',
          category: ItemCategory.protein,
          pricePence: 2400,
          servingsCount: 12,
          tags: ['halal', 'spice:2'],
        ...
        {
          name: 'Aloo Paratha (10 pieces)',
          description: 'Stuffed potato paratha - pan-fried in ghee.',
          category: ItemCategory.snack,
          pricePence: 1500,
          servingsCount: 5,
          allergens: ['gluten', 'dairy'],
    ...
    },
    {
      ...
      items: [
        {
          name: 'Lamb Shatkora Curry (Full Pot)',
          description: 'Sylheti citrus-fruit curry with bone-in lamb. Serves 8.',
          category: ItemCategory.soup,
          pricePence: 3600,
          servingsCount: 8,
          tags: ['halal', 'spice:2'],
        ...
        {
          name: 'Hilsa Fish Bhuna (Full Pot)',
          description: 'Mustard-oil hilsa, the national fish of Bangladesh. Serves 6.',
          category: ItemCategory.soup,
          pricePence: 4200,
          servingsCount: 6,
          allergens: ['fish'],
        ...
        {
          name: 'Chicken Bhuna (Full Tray)',
          description: 'Slow-reduced onion-tomato bhuna with bone-in chicken. Serves 10.',
          category: ItemCategory.tray,
          pricePence: 3000,
          servingsCount: 10,
          tags: ['halal'],
        ...
        {
          name: 'Pulao Rice (Full Tray)',
          description: 'Fragrant basmati pulao with bay leaf and cardamom. Serves 12.',
          category: ItemCategory.tray,
          pricePence: 1800,
          servingsCount: 12,
          tags: ['vegetarian'],
        ...
        {
          name: 'Bhortas Selection (4 pots)',
          description: 'Aubergine, dal, tomato, dried-fish bhortas with rice on the side.',
          category: ItemCategory.bundle,
          pricePence: 2400,
          servingsCount: 8,
          allergens: ['fish'],
    ...
    },
    {
      ...
      items: [
        {
          name: 'Chicken Kothu Roti (Full Tray)',
          description: 'Chopped godhamba roti stir-fried with chicken curry. Serves 8.',
          category: ItemCategory.tray,
          pricePence: 3000,
          servingsCount: 8,
          allergens: ['gluten', 'egg'],
        ...
        {
          name: 'Jaffna Crab Curry (Full Pot)',
          description: 'Whole blue crab in a fiery roasted-curry-powder gravy. Serves 4.',
          category: ItemCategory.soup,
          pricePence: 4800,
          servingsCount: 4,
        ...
        {
          name: 'String Hoppers (50 pieces)',
          description: 'Steamed rice-flour idiyappam - pair with sothi or dal.',
          category: ItemCategory.swallow,
          pricePence: 1800,
          servingsCount: 8,
          tags: ['vegan'],
        ...
        {
          name: 'Coconut Sambol & Pol Roti (Bundle)',
          description: 'Coconut roti with fresh pol sambol and seeni sambal.',
          category: ItemCategory.bundle,
          pricePence: 1400,
          servingsCount: 6,
          tags: ['vegan', 'spice:2'],
        ...
        {
          name: 'Devilled Prawns (Family Tray)',
          description: 'Wok-tossed prawns with onion, capsicum, and chilli. Serves 6.',
          category: ItemCategory.protein,
          pricePence: 3400,
          servingsCount: 6,
          allergens: ['crustaceans'],
    ...
    },
    {
      ...
      items: [
        {
          name: 'Pimento-Wood Jerk Chicken (Full Tray)',
          description: '24-hour-marinated jerk chicken, smoked over real pimento wood. Serves 10.',
          category: ItemCategory.tray,
          pricePence: 3800,
          servingsCount: 10,
          tags: ['spice:2'],
        ...
        {
          name: 'Curry Goat (Full Pot)',
          description: 'Bone-in goat in Scotch-bonnet curry. Serves 8.',
          category: ItemCategory.soup,
          pricePence: 4400,
          servingsCount: 8,
          tags: ['spice:2'],
        ...
        {
          name: 'Ackee & Saltfish Tray',
          description: 'National dish - ackee, salt cod, peppers and onions. Serves 6.',
          category: ItemCategory.tray,
          pricePence: 3200,
          servingsCount: 6,
          allergens: ['fish'],
        ...
        {
          name: 'Rice & Peas (Full Tray)',
          description: 'Coconut rice with red kidney beans and thyme. Serves 10.',
          category: ItemCategory.tray,
          pricePence: 2200,
          servingsCount: 10,
          tags: ['vegan'],
        ...
        {
          name: 'Beef Patties (24 pieces)',
          description: 'Flaky golden patties with seasoned mince filling.',
          category: ItemCategory.snack,
          pricePence: 2400,
          servingsCount: 12,
          allergens: ['gluten'],
        ...
        {
          name: 'Festival (20 pieces)',
          description: 'Sweet Jamaican fried dough - the perfect side for jerk.',
          category: ItemCategory.snack,
          pricePence: 1200,
          servingsCount: 10,
          allergens: ['gluten'],
    ...
    },
    {
      ...
      items: [
        {
          name: 'Doubles (24 pieces)',
          description: 'Bara flatbreads filled with curry channa and tamarind chutney.',
          category: ItemCategory.snack,
          pricePence: 2400,
          servingsCount: 12,
          allergens: ['gluten'],
        ...
        {
          name: 'Curry Goat Roti Skin Bundle',
          description: '8 dhalpuri roti with curry goat in a separate pot. Serves 8.',
          category: ItemCategory.bundle,
          pricePence: 4200,
          servingsCount: 8,
          allergens: ['gluten'],
        ...
        {
          name: 'Chicken Pelau (Full Tray)',
          description: 'One-pot rice with browned chicken, pigeon peas and coconut. Serves 10.',
          category: ItemCategory.tray,
          pricePence: 3000,
          servingsCount: 10,
          tags: [],
        ...
        {
          name: 'Pholourie & Tamarind Sauce (60 pieces)',
          description: 'Split-pea fritters with sweet-and-sour tamarind dip.',
          category: ItemCategory.snack,
          pricePence: 1800,
          servingsCount: 10,
          allergens: ['gluten'],
        ...
        {
          name: 'Bake & Shark (10 pieces)',
          description: 'Fried bake stuffed with seasoned shark, slaw, and shadow beni.',
          category: ItemCategory.snack,
          pricePence: 3200,
          servingsCount: 10,
    ...
    },
    {
      ...
      items: [
        {
          name: 'Beyaynetu Sharing Platter (Serves 6)',
          description: 'Vegan combo: shiro, miser wot, gomen, atkilt, on a 14" injera.',
          category: ItemCategory.tray,
          pricePence: 3600,
          servingsCount: 6,
          tags: ['vegan'],
        ...
        {
          name: 'Doro Wat (Full Pot)',
          description: 'Slow-simmered chicken wot with berbere and hard-boiled eggs. Serves 6.',
          category: ItemCategory.soup,
          pricePence: 3400,
          servingsCount: 6,
          allergens: ['egg'],
        ...
        {
          name: 'Kitfo (Family Tray)',
          description: 'Hand-minced beef warmed with mitmita and kibe. Serves 4.',
          category: ItemCategory.protein,
          pricePence: 4200,
          servingsCount: 4,
          allergens: ['dairy'],
        ...
        {
          name: 'Injera (10 pieces)',
          description: 'Sour teff-flour flatbread, fermented for 3 days.',
          category: ItemCategory.swallow,
          pricePence: 1500,
          servingsCount: 10,
          tags: ['vegan'],
        ...
        {
          name: 'Sambusa (24 pieces)',
          description: 'Crisp fried pastries with spiced lentil filling.',
          category: ItemCategory.snack,
          pricePence: 1800,
          servingsCount: 12,
          allergens: ['gluten'],
    ...
    },
    {
      ...
      items: [
        {
          name: 'Bariis Iskukaris (Full Tray)',
          description: 'Spiced rice with goat shoulder, sultanas and pine nuts. Serves 10.',
          category: ItemCategory.tray,
          pricePence: 3600,
          servingsCount: 10,
          allergens: ['tree_nuts'],
        ...
        {
          name: 'Suqaar (Full Pot)',
          description: 'Cubed beef sautéed with peppers, onions and xawaash spice. Serves 6.',
          category: ItemCategory.soup,
          pricePence: 2800,
          servingsCount: 6,
          tags: ['halal', 'spice:2'],
        ...
        {
          name: 'Sambusa (30 pieces)',
          description: 'Crisp triangular pastries with spiced beef filling.',
          category: ItemCategory.snack,
          pricePence: 1800,
          servingsCount: 15,
          allergens: ['gluten'],
        ...
        {
          name: 'Canjeero Pancakes (20 pieces)',
          description: 'Light fermented pancakes - eat with honey or suqaar.',
          category: ItemCategory.snack,
          pricePence: 1200,
          servingsCount: 10,
          allergens: ['gluten'],
        ...
        {
          name: 'Maraq (Family Pot)',
          description: 'Hearty Somali soup with lamb, vegetables and lemon. Serves 8.',
          category: ItemCategory.soup,
          pricePence: 2600,
          servingsCount: 8,
          tags: ['halal'],
    ...
    },
    {
      ...
      items: [
        {
          name: 'Boerewors & Pap Tray',
          description: 'Coiled boerewors, mielie pap and chakalaka relish. Serves 10.',
          category: ItemCategory.tray,
          pricePence: 3400,
          servingsCount: 10,
          tags: [],
        ...
        {
          name: 'Bobotie (Family Bake)',
          description: 'Cape-Malay spiced beef bake with egg custard topping. Serves 8.',
          category: ItemCategory.tray,
          pricePence: 3000,
          servingsCount: 8,
          allergens: ['egg', 'dairy', 'tree_nuts'],
          tags: [],
        },
        {
          name: 'Bunny Chow (6 boxes)',
          description: 'Hollowed-out half loaves filled with mutton curry. Durban classic.',
          category: ItemCategory.bundle,
          pricePence: 3600,
          servingsCount: 6,
          allergens: ['gluten'],
        ...
        {
          name: 'Chakalaka & Pap (Family Pot)',
          description: 'Spicy vegetable relish with white maize porridge. Serves 8.',
          category: ItemCategory.soup,
          pricePence: 1800,
          servingsCount: 8,
          tags: ['vegan'],
        ...
        {
          name: 'Biltong Box (500g)',
          description: 'Air-dried beef biltong - a mix of sliced and stick cuts.',
          category: ItemCategory.snack,
          pricePence: 2200,
          servingsCount: 8,
          tags: [],
    ...
    },
    {
      ...
      items: [
        {
          name: 'Mixed Mezze Platter (Serves 8)',
          description: 'Hummus, moutabal, tabbouleh, fattoush, kibbeh and falafel.',
          category: ItemCategory.tray,
          pricePence: 3800,
          servingsCount: 8,
        ...
        {
          name: 'Charcoal Mixed Grill (Full Tray)',
          description: 'Shish taouk, lamb kafta and shish kebab over charcoal. Serves 8.',
          category: ItemCategory.tray,
          pricePence: 4400,
          servingsCount: 8,
          tags: ['halal', 'spice:1'],
        ...
        {
          name: 'Falafel & Pita Box (40 falafel)',
          description: 'Fresh-fried falafel with pita, tahini and pickled turnips.',
          category: ItemCategory.bundle,
          pricePence: 2400,
          servingsCount: 10,
          allergens: ['sesame', 'gluten'],
        ...
        {
          name: 'Manakeesh Selection (24 pieces)',
          description: "Za'atar, cheese, and lamb-spiced flatbreads.",
          category: ItemCategory.snack,
          pricePence: 2200,
          servingsCount: 12,
          allergens: ['gluten', 'dairy'],
        ...
        {
          name: 'Baklava Tray (40 pieces)',
          description: 'Pistachio and walnut baklava in rosewater syrup.',
          category: ItemCategory.snack,
          pricePence: 2400,
          servingsCount: 20,
    ...
    },
    {
      ...
      items: [
        {
          name: 'Adana Kebab (Full Tray)',
          description: 'Hand-minced lamb adana skewers over charcoal. Serves 10.',
          category: ItemCategory.tray,
          pricePence: 4200,
          servingsCount: 10,
          tags: ['halal', 'spice:2'],
        ...
        {
          name: 'Lahmacun (24 pieces)',
          description: 'Thin Turkish flatbreads with spiced lamb topping.',
          category: ItemCategory.snack,
          pricePence: 2400,
          servingsCount: 12,
          allergens: ['gluten'],
        ...
        {
          name: 'Pide Selection (8 boats)',
          description: 'Cheese, sucuk, and minced-lamb pide boats.',
          category: ItemCategory.bundle,
          pricePence: 2800,
          servingsCount: 8,
          allergens: ['gluten', 'dairy'],
        ...
        {
          name: 'Iskender Tray (Serves 6)',
          description: 'Sliced döner over pide with tomato sauce and yoghurt.',
          category: ItemCategory.tray,
          pricePence: 3600,
          servingsCount: 6,
          allergens: ['gluten', 'dairy'],
        ...
        {
          name: 'Mezze & Bread Box',
          description: 'Hummus, cacık, ezme, kısır with warm Turkish bread. Serves 8.',
          category: ItemCategory.bundle,
          pricePence: 2200,
          servingsCount: 8,
    ...
    },
    {
      ...
      items: [
        {
          name: 'Chelo Kebab Koobideh (Full Tray)',
          description: 'Saffron rice with charcoal-grilled minced lamb skewers. Serves 8.',
          category: ItemCategory.tray,
          pricePence: 4400,
          servingsCount: 8,
          tags: ['halal'],
        ...
        {
          name: 'Ghormeh Sabzi (Full Pot)',
          description: 'Slow-cooked herb stew with lamb, kidney beans and dried lime. Serves 6.',
          category: ItemCategory.soup,
          pricePence: 3400,
          servingsCount: 6,
          tags: ['halal'],
        ...
        {
          name: 'Fesenjan (Full Pot)',
          description: 'Pomegranate-walnut chicken stew. Serves 6.',
          category: ItemCategory.soup,
          pricePence: 3800,
          servingsCount: 6,
          allergens: ['tree_nuts'],
        ...
        {
          name: 'Zereshk Polo (Full Tray)',
          description: 'Barberry rice with saffron chicken. Serves 8.',
          category: ItemCategory.tray,
          pricePence: 3600,
          servingsCount: 8,
          tags: ['halal'],
        ...
        {
          name: 'Mast-o-Khiar & Sangak Bundle',
          description: 'Cucumber-mint yoghurt with warm sangak bread.',
          category: ItemCategory.bundle,
          pricePence: 1400,
          servingsCount: 8,
          allergens: ['gluten', 'dairy'],
    ...
    },
    {
      ...
      items: [
        {
          name: 'Chicken Adobo (Full Pot)',
          description: 'Vinegar-and-soy braised chicken with bay leaves. Serves 8.',
          category: ItemCategory.soup,
          pricePence: 2800,
          servingsCount: 8,
          tags: [],
        ...
        {
          name: 'Lechon Kawali (Full Tray)',
          description: 'Twice-cooked crispy pork belly with liver sauce. Serves 6.',
          category: ItemCategory.tray,
          pricePence: 3400,
          servingsCount: 6,
          tags: [],
        ...
        {
          name: 'Pancit Palabok (Family Tray)',
          description: 'Rice noodles in shrimp sauce with chicharrón and egg. Serves 8.',
          category: ItemCategory.tray,
          pricePence: 2600,
          servingsCount: 8,
        ...
        {
          name: 'Sinigang na Baboy (Family Pot)',
          description: 'Sour tamarind soup with pork ribs and vegetables. Serves 6.',
          category: ItemCategory.soup,
          pricePence: 3000,
          servingsCount: 6,
          tags: [],
        ...
        {
          name: 'Lumpiang Shanghai (40 pieces)',
          description: 'Crispy pork-and-veg spring rolls with sweet-chilli dip.',
          category: ItemCategory.snack,
          pricePence: 2000,
          servingsCount: 20,
          allergens: ['gluten'],
    ...
    },
    {
      ...
      items: [
        {
          name: 'Pho Bo DIY Kit (Serves 8)',
          description: '24-hour-simmered beef pho broth, rice noodles, sliced beef, herbs.',
          category: ItemCategory.bundle,
          pricePence: 4200,
          servingsCount: 8,
          allergens: ['gluten'],
        ...
        {
          name: 'Bun Cha Hanoi (Family Tray)',
          description: 'Char-grilled pork patties with vermicelli, herbs and nuoc cham.',
          category: ItemCategory.tray,
          pricePence: 3400,
          servingsCount: 6,
          allergens: ['fish'],
        ...
        {
          name: 'Banh Mi Box (10 sandwiches)',
          description: 'Crusty baguettes with grilled pork, pâté, pickled veg, coriander.',
          category: ItemCategory.bundle,
          pricePence: 3500,
          servingsCount: 10,
          allergens: ['gluten', 'egg'],
        ...
        {
          name: 'Goi Cuon Fresh Rolls (24 pieces)',
          description: 'Rice-paper rolls with prawn, pork and herbs + peanut dip.',
          category: ItemCategory.snack,
          pricePence: 2400,
          servingsCount: 12,
        ...
        {
          name: 'Com Tam Suon (Full Tray)',
          description: 'Broken rice with grilled lemongrass pork chop. Serves 8.',
          category: ItemCategory.tray,
          pricePence: 3000,
          servingsCount: 8,
          tags: [],
    ...
    },
    {
      ...
      items: [
        {
          name: 'Green Curry Chicken (Full Pot)',
          description: 'Coconut green curry with chicken, aubergine and Thai basil. Serves 8.',
          category: ItemCategory.soup,
          pricePence: 3000,
          servingsCount: 8,
          tags: ['spice:2'],
        ...
        {
          name: 'Pad Krapow Moo (Family Tray)',
          description: 'Stir-fried minced pork with holy basil and chilli. Serves 8.',
          category: ItemCategory.tray,
          pricePence: 2800,
          servingsCount: 8,
          tags: ['spice:3'],
        ...
        {
          name: 'Khao Soi (Family Pot)',
          description: 'Northern Thai coconut-curry noodle soup with chicken thigh. Serves 6.',
          category: ItemCategory.soup,
          pricePence: 3200,
          servingsCount: 6,
          allergens: ['gluten'],
        ...
        {
          name: 'Som Tam Thai (Family Bowl)',
          description: 'Pounded green-papaya salad with peanuts and dried shrimp.',
          category: ItemCategory.snack,
          pricePence: 1600,
          servingsCount: 6,
        ...
        {
          name: 'Mango Sticky Rice (Family Tray)',
          description: 'Coconut sticky rice with sweet alphonso mango.',
          category: ItemCategory.snack,
          pricePence: 1800,
          servingsCount: 8,
          tags: ['vegan'],
    ...
    },
    {
      ...
      items: [
        {
          name: 'Pierogi Ruskie (50 pieces)',
          description: 'Potato-and-cheese pierogi with caramelised onion butter.',
          category: ItemCategory.tray,
          pricePence: 2800,
          servingsCount: 10,
          allergens: ['gluten', 'dairy'],
        ...
        {
          name: 'Pierogi z Mięsem (50 pieces)',
          description: 'Beef-and-pork pierogi pan-fried in butter.',
          category: ItemCategory.tray,
          pricePence: 3200,
          servingsCount: 10,
          allergens: ['gluten', 'dairy'],
        ...
        {
          name: 'Bigos (Family Pot)',
          description: "Hunter's stew with sauerkraut, pork, and Polish sausage. Serves 8.",
          category: ItemCategory.soup,
          pricePence: 2800,
          servingsCount: 8,
          tags: [],
        ...
        {
          name: 'Golabki (12 cabbage rolls)',
          description: 'Cabbage rolls stuffed with rice and minced pork in tomato sauce.',
          category: ItemCategory.tray,
          pricePence: 3000,
          servingsCount: 6,
          tags: [],
        ...
        {
          name: 'Żurek Frozen Pack (4 portions)',
          description: 'Sour rye soup with sausage and egg - reheat from frozen.',
          category: ItemCategory.frozen,
          pricePence: 1600,
          servingsCount: 4,
          allergens: ['gluten', 'egg'],
    ...
    },
    {
      ...
      items: [
        {
          name: 'Feijoada Completa (Family Pot)',
          description: 'Black-bean stew with pork ribs, smoked sausage and bacon. Serves 8.',
          category: ItemCategory.soup,
          pricePence: 3800,
          servingsCount: 8,
          tags: [],
        ...
        {
          name: 'Picanha Tray (Serves 8)',
          description: 'Wood-fire-grilled rump cap with farofa and vinaigrette.',
          category: ItemCategory.tray,
          pricePence: 4800,
          servingsCount: 8,
          tags: [],
        ...
        {
          name: 'Pão de Queijo (40 pieces)',
          description: 'Cheesy tapioca-flour bread balls - addictive when warm.',
          category: ItemCategory.snack,
          pricePence: 2000,
          servingsCount: 20,
          allergens: ['dairy'],
        ...
        {
          name: 'Moqueca (Family Pot)',
          description: 'Coconut-and-palm-oil fish stew from Bahia. Serves 6.',
          category: ItemCategory.soup,
          pricePence: 3600,
          servingsCount: 6,
          allergens: ['fish'],
        ...
        {
          name: 'Coxinha (30 pieces)',
          description: 'Teardrop-shaped chicken croquettes with catupiry cheese.',
          category: ItemCategory.snack,
          pricePence: 2200,
          servingsCount: 15,
          allergens: ['gluten', 'dairy'],
    ...
    },
    {
      ...
      items: [
        {
          name: 'Lamb Tagine with Prunes (Family Pot)',
          description: 'Slow-cooked lamb shoulder with prunes, almonds and saffron. Serves 6.',
          category: ItemCategory.soup,
          pricePence: 4200,
          servingsCount: 6,
          allergens: ['tree_nuts'],
        ...
        {
          name: 'Chicken Tagine with Olives & Lemon (Family Pot)',
          description: 'Bone-in chicken with preserved lemon and Kalamata olives. Serves 6.',
          category: ItemCategory.soup,
          pricePence: 3400,
          servingsCount: 6,
          tags: ['halal'],
        ...
        {
          name: 'Couscous Royale (Full Tray)',
          description:
            'Steamed couscous with seven vegetables, lamb, chicken and merguez. Serves 10.',
          category: ItemCategory.tray,
          pricePence: 4400,
          servingsCount: 10,
          allergens: ['gluten'],
        ...
        {
          name: 'Chicken Pastilla (Family Pie)',
          description: 'Sweet-and-savoury filo pie with chicken, almonds and cinnamon. Serves 8.',
          category: ItemCategory.tray,
          pricePence: 3600,
          servingsCount: 8,
          allergens: ['gluten', 'tree_nuts', 'egg'],
          tags: ['halal'],
        },
        {
          name: 'Harira (Family Pot)',
          description: 'Tomato-lentil-chickpea soup, perfect for iftar. Serves 8.',
          category: ItemCategory.soup,
          pricePence: 2200,
          servingsCount: 8,
          allergens: ['gluten'],
  ...
  const graceAddr = await prisma.address.upsert({
    where: {
      id:
        (await prisma.address.findFirst({ where: { userId: graceId } }))?.id ??
  ...
  const davidAddr = await prisma.address.upsert({
    where: {
      id:
        (await prisma.address.findFirst({ where: { userId: davidId } }))?.id ??
    ...
    data: {
      ...
      payments: {
        create: {
          ...
          amountPence: 6500,
          processedAt: new Date('2026-04-25T10:55:00Z'),
        },
      },
    },
  });
    ...
    data: {
      ...
      payments: {
        create: {
          ...
          status: PaymentStatus.succeeded,
          amountPence: 4300,
          processedAt: new Date('2026-05-08T11:55:00Z'),
        },
      },
    },
  });
  ...
  await prisma.order.create({
    data: {
      ...
      items: {
        create: [
          {
            menuItemId: smallChops.id,
            nameSnapshot: smallChops.name,
            quantity: 1,
            unitPence: smallChops.pricePence,
            totalPence: smallChops.pricePence,
          },
        ],
      },
      payments: {
  ...
  await prisma.order.create({
    data: {
      ...
      items: {
        create: [
          {
            menuItemId: kwameJollof.id,
            nameSnapshot: kwameJollof.name,
            quantity: 1,
            unitPence: kwameJollof.pricePence,
            totalPence: kwameJollof.pricePence,
          },
        ],
      },
    },
  ...
  const o5 = await prisma.order.create({
    data: {
      ...
      items: {
        create: [
          {
            menuItemId: frozenEgusi.id,
            nameSnapshot: frozenEgusi.name,
            quantity: 2,
            unitPence: frozenEgusi.pricePence,
            totalPence: frozenEgusi.pricePence * 2,
          },
        ],
      },
      payments: {
  ...
  await prisma.review.create({
    data: {
      ...
      customerId: graceId,
      rating: 5,
      body: 'Absolutely incredible! The egusi tasted exactly like my mum makes it. Will be ordering every week!',
      isVerified: true,
      isHidden: false,
    },
  });
  await prisma.review.create({
    data: {
      ...
      customerId: graceId,
      rating: 5,
      body: 'Frozen packs are a lifesaver during the week. Reheats perfectly.',
      isVerified: true,
      isHidden: false,
    },
  });
  ...
  const davidOrder = await prisma.order.findFirst({
    where: { customerId: davidId, vendorId: kwame.id },
  });
  if (davidOrder) {
    await prisma.review.create({
      data: {
        ...
        customerId: davidId,
        rating: 3,
        body: 'Good food but delivery was late',
        isVerified: false,
        isHidden: true,
      },
    });
