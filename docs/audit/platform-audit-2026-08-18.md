...
A seed ordering bug was found and fixed in this session: sections 2c/2d/2e (vendor member, verifications, discount codes) were created _before_ the section 2b cleanup, causing them to be immediately deleted. Fix: moved 2b before 2c/2d/2e. DB state after corrected re-run:
